...
$options[]    = array(
  ...
  'title'     => __('Portfolio Post Options', 'themx'),
  'post_type' => 'portfolio',
  'context'   => 'normal',
  'priority'  => 'default',
  'sections'  => array(
    ...
    array(
      'name'   => 'portfolio_sec_1',
      'title'   => __('portfolio name and Designation','themx'),
      'icon'   => 'fa fa-cog',
      'fields' => array(
        ...
        array(
          ...
          'id'    => 'port_title',
          'type'  => 'text',
          'title' => __('Portfolio Title','themx'),
         ...
         array(
          ...
          'id'    => 'port_deg',
          'type'  => 'text',
          'title' => __('Portfolio Sub-Title','themx'),
