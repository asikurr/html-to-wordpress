...
// ----------------------------------------
// a option section for Header logo       -
// ----------------------------------------
$options[]      = array(
  'name'        => 'head_logo',
  'title'       => 'Header Logo',
...
// ----------------------------------------
// a option section for footer copyright  -
// ----------------------------------------
$options[]      = array(
  'name'        => 'foo_copuright',
  ...
  'fields'      => array(
    ...
    array(
      'id'      => 'copyright_1',
      'type'    => 'text',
      'title'   => 'Write 1st Part',
    ),
    array(
      'id'      => 'copyright_2',
      'type'    => 'text',
      'title'   => 'Write 2nd Part',
    ),
    array(
      'id'      => 'copyright_3',
      'type'    => 'text',
      'title'   => 'Write 3rd Part',
    ),

    array(
      'id'      => 'copyright_4',
      'type'    => 'text',
      'title'   => 'Write 4th Part',
    ),
...
// ------------------------------------------------------------------
// a option section for single 404 and archive page banner & title  -
// ------------------------------------------------------------------
$options[]      = array(
  'name'        => 'banner_title',
  'title'       => 'Banner And Title',
  'icon'        => 'fa fa-star',
  ...
  'fields'      => array(
        ...
        array(
        'type'    => 'heading',
        'content' => 'Heading Field for Author social Link and icon',

        ),
array(
  'id'              => 'author_link_icon',
  'type'            => 'group',
  'title'           => 'Group Field Author link and icon',
  ...
  'fields'          => array(
    ...
    array(
      ...
      'title' => 'Author Social icon',
        ...
        array(
        'type'    => 'heading',
        'content' => 'Heading Field for single page Banner & Title',
    ...
    array(
      'id'      => 's_sub_title',
      'type'    => 'textarea',
      'title'   => 'Single Page Sub-Title',
    ),
        array(
        'type'    => 'heading',
        'content' => 'Heading Field for 404 page Banner & Title',
